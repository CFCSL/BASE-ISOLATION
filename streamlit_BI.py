...
data=Iteration(m,n,n_c,W_SS, W_PP,W,K_sub,angle_skew,PGA, S_1,S_S, SiteClass,q,k,tol,T_max, Isolator_Type, latex_format=False)
st.image('response_spectrum_plot.png', use_column_width=True)
