...
#%%
def Iteration(m,n,n_c,W_SS, W_PP,W,K_sub,angle_skew,PGA, S_1,S_S, SiteClass,q,k,tol,T_max, Isolator_Type,latex_format=True,d=2.0):
...
## Step 2: Multimode  
    ...
    while True:
        ...
        K_isoli=[Q_di[j]/d_isolj[j]+K_di[j] for j in range(m)] # (d_isoli in the document) is d_isolj in the convergence step
    ...
    print(f'Numbers of iteratations for multimode: {iter_multimode}')

   

    return data,d_multimode_new,x_L, y_L,u_L,v_L
