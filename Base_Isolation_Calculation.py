...
def B1(params,d,latex_format=True,plot_action=False):
	d0, m, n, n_c, W_SS, W_PP, W, K_sub, angle_skew, PGA, S_1, S_S, SiteClass, T_max, Isolator_Type, q, k, tol = params
	"""
...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 31 18:25:11 2023

@author: namnguyen
"""


def B2(params, latex_format=True):
	d0, m, n, n_c, W_SS, W_PP, W, K_sub, angle_skew, PGA, S_1, S_S, SiteClass, T_max, Isolator_Type, q, k, tol = params
...
## Step 1: Iteration
	dt=B1(params,d=4,latex_format=False,plot_action=False)
...
## Step 2: Multimode  
	...
	while True:
		...
		# Update d_soli 
		df=B1(params,d=d_new,latex_format=True,plot_action=False)
